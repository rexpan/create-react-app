...
module.exports = {
  ...
  appTsConfig: process.env.NODE_ENV === 'development' ? resolveApp('tsconfig.dev.json') : resolveApp('tsconfig.json'),
...
if (
  ...
  module.exports = {
    ...
    appTsConfig: process.env.NODE_ENV === 'development' ? resolveOwn(`${templatePath}/tsconfig.dev.json`) : resolveOwn(`${templatePath}/tsconfig.json`),
